...
python jb_baseline.py --scenario="ni" --sub_dir="ni"
python jb_baseline.py --scenario="multi-task-nc" --sub_dir="multi-task-nc"
python jb_baseline.py --scenario="nic" --sub_dir="nic"
